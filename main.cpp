...
int WINAPI WinMain(_In_ HINSTANCE, _In_opt_ HINSTANCE, _In_ LPSTR, _In_ int) {
    ...
    fanfareSound.Initialize();
    fanfareSound.LoadWave("resources/fanfare.wav");
    ...
    ComPtr<IDxcBlob> vertexShaderBlob = CompileShader(L"Object3d_VS.hlsl", L"vs_6_0", dxcUtils.Get(), dxcCompiler.Get(), includeHandler.Get());
    ComPtr<IDxcBlob> pixelShaderBlob = CompileShader(L"Object3d_PS.hlsl", L"ps_6_0", dxcUtils.Get(), dxcCompiler.Get(), includeHandler.Get());
    ...
    ComPtr<ID3D12Resource> vertexResource = CreateBufferResource(device.Get(), sizeof(VertexData) * kSphereVertexCount);
